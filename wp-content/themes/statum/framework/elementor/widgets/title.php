...
class Statum_Elementor_Global_Widgets_Title extends Widget_Base {
	...
	public function get_name() {
		return 'Statum-Global-Widgets-Title';
	}
	...
	public function get_title() {
		return esc_html__( 'QK Title', 'statum' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Block Title', 'statum' ),
			)
		);
		...
		$this->add_control(
		    'ex_class',
		    [
		        'label' => esc_html__( 'Custom Class', 'statum' ),
		        'type' => Controls_Manager::TEXT,

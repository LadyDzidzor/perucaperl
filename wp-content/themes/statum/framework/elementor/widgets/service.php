...
class Statum_Elementor_Global_Widgets_Service_Post extends Widget_Base {

	/**
	 * Retrieve Statum_Elementor_Global_Widgets_Service_Post widget name.
	 *
	 * @access public
	 *
	...
	public function get_name() {
		return 'Statum-Global-Widgets-Service-Post';
	}

	/**
	 * Retrieve Statum_Elementor_Global_Widgets_Service_Post widget title.
	 *
	 * @access public
	 *
	...
	public function get_title() {
		return esc_html__( 'QK Service Post', 'statum' );
	}

	/**
	 * Retrieve Statum_Elementor_Global_Widgets_Service_Post widget icon.
	 *
	 * @access public
	 *
	...
	/**
	 * Retrieve the list of categories the Statum_Elementor_Global_Widgets_Service_Post widget belongs to.
	 *
	...
	/**
	 * Register Statum_Elementor_Global_Widgets_Service_Post widget controls.
	 *
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Service Post', 'statum' ),
			)
		);
	...
	/**
	 * Render Statum_Elementor_Global_Widgets_Service_Post widget output on the frontend.
	 *

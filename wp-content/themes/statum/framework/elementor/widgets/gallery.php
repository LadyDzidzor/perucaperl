...
class Statum_Elementor_Global_Widgets_Gallery extends Widget_Base {
	...
	public function get_name() {
		return 'Statum-Global-Widgets-Gallery';
	}
	...
	public function get_title() {
		return esc_html__( 'Statum Gallery', 'statum' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Gallery', 'statum' ),
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'client_title' => esc_html__( 'Gallery #1', 'statum' ),
						
					],
					[
						'client_title' => esc_html__( 'Gallery #2', 'statum' ),
				...
				'fields' => [
					...
					[
						...
						'name' => 'filter_class',
						'label' => esc_html__( 'Filter Class', 'statum' ),
						'type' => Controls_Manager::TEXT,
						'default' => '',
						'label_block' => true,
					]

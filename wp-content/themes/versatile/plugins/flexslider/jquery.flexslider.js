...
(function ($) {
  ...
  $.versatile_flexslider = function(el, options) {
    var slider = $(el);

    // making variables public
    slider.vars = $.extend({}, $.versatile_flexslider.defaults, options);
    ...
    $.data(el, "versatile_flexslider", slider);
    ...
    methods = {
        ...
        setup: function() {
          ...
          if(!msGesture){
              slider.slides.click(function(e){
                ...
                } else if (!$(slider.vars.asNavFor).data('versatile_flexslider').animating && !$slide.hasClass(namespace + "active-slide")) {
              ...
              slider.slides.each(function (){
                  ...
                  that.addEventListener("MSGestureTap", function (e){
                      ...
                      var $slide = $(this),
                          target = $slide.index();
                      if (!$(slider.vars.asNavFor).data('versatile_flexslider').animating && !$slide.hasClass('active')) {
                          slider.direction = (slider.currentItem < target) ? "next" : "prev";
                          slider.flexAnimate(target, slider.vars.pauseOnAction, false, true, true);
                      }
                  });
      ...
      sync: function(action) {
        var $obj = $(slider.vars.sync).data("versatile_flexslider"),
    ...
    slider.flexAnimate = function(target, pause, override, withSync, fromNav) {
      ...
      if (!slider.animating && (slider.canAdvance(target, fromNav) || override) && slider.is(":visible")) {
        if (asNav && withSync) {
          var master = $(slider.vars.asNavFor).data('versatile_flexslider');
  ...
  $.fn.versatile_flexslider = function(options) {
    ...
    if (typeof options === "object") {
      ...
      if ( ( $slides.length === 1 && options.allowOneSlide === true ) || $slides.length === 0 ) {
        ...
        } else if ($this.data('versatile_flexslider') === undefined) {
          new $.versatile_flexslider(this, options);
        }
      });
    } else {
      // Helper strings to quickly perform functions on the slider
      var $slider = $(this).data('versatile_flexslider');
      switch (options) {

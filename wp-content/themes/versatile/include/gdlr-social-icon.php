	...
	*/
	...
	if( !function_exists('gdlr_register_header_social_option') ){
		function gdlr_register_header_social_option( $array ){		
			...
			if( !empty($gdlr_header_social_icon) ){
...
<img width="32" height="32" src="<?php echo GDLR_PATH . '/images/' . esc_attr($type) . '/social-icon/' . $social_slug . '.png'; ?>" alt="<?php echo esc_attr($social_name); ?>" />
</a>
</div>
<?php				
				}

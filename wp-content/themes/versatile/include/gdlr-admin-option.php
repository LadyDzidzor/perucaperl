					...
					array(
						...
						'general' => array(
							...
							'options' => array(
								...
								'privacy' => array(
									'title' => esc_html__('Privacy', 'gdlr_translate'),
									'options' => array(
										'disable-cookie-youtube' => array(
											'title' => esc_html__('Disable Cookie On Youtube Videos', 'gdlr_translate'),
											'type' => 'checkbox',
											'default' => 'disable'
										)
									)
						...
						'overall-elements' => array(
							...
							'options' => array(
								...
								'header-logo' => array(
									...
									'options' => array(
										'header-style' => array(
											'title' => __('Default Header Style', 'gdlr_translate'),
											'type' => 'combobox',
											'options' => array(
												'solid'=> __('Header Solid', 'gdlr_translate'),
												'transparent'=> __('Header Transparent', 'gdlr_translate'),
											),
											'default' => 'solid'
										),									
						...
						'elements-color' => array(
							...
							'options' => array(
								...
								'top-bar-color' => array(
									'title' => __('Top Bar / Main Menu', 'gdlr_translate'),
									'options' => array(						
										...
										'bucket-color' => array(
											...
											'default' => 'dark',
											'selector'=> '.gdlr-top-woocommerce-button, ' . 
												'.header-style-transparent .gdlr-fixed-header .gdlr-top-woocommerce-button{ background: url("../images/shopping-bag-#gdlr#.png"); }'
										),										
										'transparent-main-navigation-text' => array(
											'title' => __('Transparent Header - Main Navigation Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.header-style-transparent .gdlr-main-menu > li > a{ color: #gdlr#; }'
										),	
										'transparent-main-navigation-text-hover' => array(
											...
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.header-style-transparent .gdlr-main-menu > li:hover > a, ' . 
												'.header-style-transparent .gdlr-main-menu > li.current-menu-item > a, ' .
												'.header-style-transparent .gdlr-main-menu > li.current-menu-ancestor > a{ color: #gdlr#; opacity: 0.5; filter: alpha(opacity=50); }'
										),	
										'transparent-bucket-color' => array(
											'title' => __('Transparent Header - Woo Commerce Bucket Color', 'gdlr_translate'),
											'type' => 'combobox',
											'data-type' => 'text',
											'options' => array(
												'dark' => __('Dark', 'gdlr_translate'), 
											...
											'default' => 'light',
											'selector'=> '.header-style-transparent .gdlr-top-woocommerce-button{ background: url("../images/shopping-bag-#gdlr#.png"); }'
										)
									)
								),		

								'main-navigation-color' => array(
									'title' => __('Sub Menu / Search', 'gdlr_translate'),
									'options' => array(
								...
								'blog-color' => array(
									...
									'options' => array(
										...
										'blog-grid-background' => array(
											'title' => __('Blog Grid Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-blog-grid, .gdlr-blog-widget .post-header{ background-color: #gdlr#; }'
										),
										'blog-grid-info-color' => array(
											'title' => __('Blog Grid Info Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#aeaeae',
											'selector'=> '.gdlr-blog-grid .blog-info, .gdlr-blog-grid .blog-info a, .gdlr-blog-grid .blog-info i, ' . 
												'.gdlr-blog-widget .blog-info, .gdlr-blog-widget .blog-info a, .gdlr-blog-widget .blog-info i{ color: #gdlr#; }'
										),	
										'blog-grid-read-more-text' => array(
											'title' => __('Blog Grid Read More Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#b7b7b7',
											'selector'=> '.gdlr-blog-grid .gdlr-grid-read-more a{ color: #gdlr#; }'
										),	
										'blog-grid-read-more-hover' => array(
											'title' => __('Blog Grid Read More Hober', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#e36d39 ',
											'selector'=> '.gdlr-blog-grid .gdlr-grid-read-more a:hover{ color: #gdlr#; }'
										),
								...
								'portfolio-color' => array(
									...
									'options' => array(
										'portfolio-filter-button-active-background' => array(
											...
											'type' => 'colorpicker',
											'default' => '#333333',
											'selector'=> '.portfolio-item-filter a.active{ background-color: #gdlr#; } '
										),					
